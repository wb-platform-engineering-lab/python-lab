...
Everything from Phase 1 working together:
  - loops to iterate over orders
  - conditionals to validate and route
  - functions to isolate each concern
  - None/truthiness to handle missing data
  - multiple return values to pass structured results
"""
